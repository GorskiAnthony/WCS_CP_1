...
*/
// ⚠️ MAJ
// Commenter le tableau persons pour éviter les maladresses
// [
...
function findAdults(arr) {
	// Your code here !
	const men = arr.filter((person) => {
		return person.sex === "male" && person.age >= 18;
	});

	const women = arr.filter(
		(person) => person.sex === "female" && person.age >= 18
	);
